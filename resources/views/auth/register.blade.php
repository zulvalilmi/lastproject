            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Buat Akun Santri Baru</h5>
                    <p class="text-center small">Khusus untuk Santri Baru, Ustadzah Silahkan Hubungi Koordinator Tahfidz</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <label for="password-confirm" class="form-label">Password confrim</label>
                      <input type="password" name="password_confirmation" class="form-control @error('password') is-invalid @enderror" id="password-confirm" required>
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
