  ...
  <section id="hero">
    ...
    <div class="container">
      <div class="row justify-content-between">
        ...
        <div class="col-lg-5 order-3 order-lg-4 hero-img" data-aos="zoom-out" data-aos-delay="400">
          <img src="landing/img/quran.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right">
            <img src="landing/img/details-1.png" class="img-fluid" alt="">
          </div>
        ...
        <div class="row content">
          <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
            <img src="landing/img/details-2.png" class="img-fluid" alt="">
          </div>
        ...
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right">
            <img src="landing/img/details-3.png" class="img-fluid" alt="">
          </div>
        ...
        <div class="row content">
          <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
            <img src="landing/img/details-4.png" class="img-fluid" alt="">
          </div>
          <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
        ...
        <div class="row g-0" data-aos="fade-left">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="100">
              <a href="landing/img/gallery/gallery-1.png" class="gallery-lightbox">
                <img src="landing/img/gallery/gallery-1.png" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="150">
              <a href="landing/img/gallery/gallery-2.png" class="gallery-lightbox">
                <img src="landing/img/gallery/gallery-2.png" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="200">
              <a href="landing/img/gallery/gallery-3.png" class="gallery-lightbox">
                <img src="landing/img/gallery/gallery-3.png" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="250">
              <a href="landing/img/gallery/gallery-4.jpg" class="gallery-lightbox">
                <img src="landing/img/gallery/gallery-4.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="300">
              <a href="landing/img/gallery/gallery-5.jpg" class="gallery-lightbox">
                <img src="landing/img/gallery/gallery-5.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="350">
              <a href="landing/img/gallery/gallery-6.jpg" class="gallery-lightbox">
                <img src="landing/img/gallery/gallery-6.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="400">
              <a href="landing/img/gallery/gallery-7.jpg" class="gallery-lightbox">
                <img src="landing/img/gallery/gallery-7.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450">
              <a href="landing/img/gallery/gallery-8.jpg" class="gallery-lightbox">
                <img src="landing/img/gallery/gallery-8.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="footer-info">
              ...
              <p>
                I'm From <br>
                North Jakarta<br><br>
                <strong>Phone:</strong> +62 812 5456 1111<br>
                <strong>Email:</strong> zulvaalilmi04@gmail.com<br>
              </p>
